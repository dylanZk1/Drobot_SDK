...
import (
	...
	//	"encoding/json"
	"fmt"
	//"drobot_sdk/internal/drobot_im_sdk"
	//"drobot_sdk/pkg/utils"
	//	"drobot_sdk/internal/common"
)
...
func DoTestCreateGroup() {
	...
	drobot_im_sdk.CreateGroup(test, test.OperationID, g1, g2)
}
...
func DoSetGroupInfo() {
	...
	drobot_im_sdk.SetGroupInfo(test, test.OperationID, TestgroupID, setInfo)
...
func DoSetGroupVerification() {
	var test testSetGroupInfo
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.SetGroupVerification(test, test.OperationID, TestgroupID, 1)
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input: ", TestgroupID, 2)
}
func DoSetGroupLookMemberInfo() {
	var test testSetGroupInfo
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.SetGroupLookMemberInfo(test, test.OperationID, TestgroupID, 0)
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input: ", TestgroupID, 1)
}
func DoSetGroupApplyMemberFriend() {
	var test testSetGroupInfo
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.SetGroupApplyMemberFriend(test, test.OperationID, TestgroupID, 1)
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input: ", TestgroupID, 1)
}
...
func DoTestGetGroupsInfo() {
	...
	drobot_im_sdk.GetGroupsInfo(test, test.OperationID, list)
}
func DoTestSearchGroups() {
	...
	drobot_im_sdk.SearchGroups(test, test.OperationID, utils.StructToJsonString(params))
}
...
func DoTestJoinGroup() {
	...
	drobot_im_sdk.JoinGroup(test, test.OperationID, groupID, reqMsg, constant.JoinBySearch)
}
...
func DoTestQuitGroup() {
	...
	drobot_im_sdk.QuitGroup(test, test.OperationID, groupID)
}
...
func DoTestGetJoinedGroupList() {
	...
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.GetJoinedGroupList(test, test.OperationID)
}
...
func DotestGetGroupMemberList() {
	...
	drobot_im_sdk.GetGroupMemberList(test, test.OperationID, groupId, 4, 0, 100)
}
...
func DotestGetGroupMemberListByJoinTimeFilter() {
	...
	drobot_im_sdk.GetGroupMemberListByJoinTimeFilter(test, test.OperationID, "3750066757", 1, 40, 0, 0, jlist)
}
func DotestKickGroupMember() {
	...
	jlist := utils.StructToJsonString(memlist)
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input ", jlist)
	drobot_im_sdk.KickGroupMember(test, test.OperationID, TestgroupID, "kkk", jlist)
}
...
func DotestInviteUserToGroup() {
	...
	jlist := utils.StructToJsonString(memlist)
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input ", jlist)
	drobot_im_sdk.InviteUserToGroup(test, test.OperationID, TestgroupID, "come", string(jlist))
}
...
func DotestGetRecvGroupApplicationList() string {
	...
	drobot_im_sdk.GetRecvGroupApplicationList(test, test.OperationID)
	return ""
}
...
func DotestTransferGroupOwner() {
	...
	drobot_im_sdk.TransferGroupOwner(test, test.OperationID, TestgroupID, MemberUserID)
...
func DoTestAcceptGroupApplication(uid string) {
	...
	test.OperationID = utils.OperationIDGenerator()
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input: ")
	drobot_im_sdk.AcceptGroupApplication(test, test.OperationID, TestgroupID, MemberUserID, "ok")
}
...
func DoTestGetUserReqGroupApplicationList() {
	...
	test.OperationID = utils.OperationIDGenerator()
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input: ")
	drobot_im_sdk.GetSendGroupApplicationList(test, test.OperationID)
}
...
func DotestRefuseGroupApplication(uid string) {
	...
	test.OperationID = utils.OperationIDGenerator()
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input: ")
	drobot_im_sdk.RefuseGroupApplication(test, test.OperationID, TestgroupID, MemberUserID, "no")
}
...
func DotestSetGroupMemberNickname(myUserID string) {
	...
	test.OperationID = utils.OperationIDGenerator()
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input: ")
	drobot_im_sdk.SetGroupMemberNickname(test, test.OperationID, TestgroupID, myUserID, "")
...
func DoTestSetGroupMemberRoleLevel(groupID, userID string, roleLevel int) {
	...
	drobot_im_sdk.SetGroupMemberRoleLevel(test, test.OperationID, groupID, userID, roleLevel)
}
...
func DoTestSetGroupMemberInfo(groupID, userID string, ex string) {
	...
	drobot_im_sdk.SetGroupMemberInfo(test, test.OperationID, g1)
}
