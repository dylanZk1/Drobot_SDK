...
//	drobot_im_sdk.SetConversationRecvMessageOpt(&callback, string(jsontest), 2)
...
//	jsontest, _ := json.Marshal(idList)
//	drobot_im_sdk.GetMultipleConversation(string(jsontest), &callback)
...
//	idList = append(idList, "18567155635")
//	jsontest, _ := json.Marshal(idList)
//	drobot_im_sdk.GetConversationRecvMessageOpt(&callback, string(jsontest))
...
func DoTestDeleteAllMsgFromLocalAndSvr() {
	...
	drobot_im_sdk.DeleteAllMsgFromLocalAndSvr(deleteConversationCallback, operationID)
}
func DoTestSearchLocalMessages() {
	...
	drobot_im_sdk.SearchLocalMessages(testSearchLocalMessagesCallBack, testSearchLocalMessagesCallBack.OperationID, utils.StructToJsonString(params))
}
...
func DoTestGetHistoryMessage(userID string) {
	...
	params.Count = 10
	drobot_im_sdk.GetHistoryMessageList(testGetHistoryCallBack, testGetHistoryCallBack.OperationID, utils.StructToJsonString(params))
}
func DoTestFindMessageList() {
	...
	drobot_im_sdk.FindMessageList(testFindMessageListCallBack, testFindMessageListCallBack.OperationID, utils.StructToJsonString(params))
}
func DoTestSetMessageReactionExtensions() {
	...
	//params = append(params, &temp1)
	drobot_im_sdk.SetMessageReactionExtensions(testSetMessageReactionExtensionsCallBack, testSetMessageReactionExtensionsCallBack.OperationID, utils.StructToJsonString(s),
...
func DoTestAddMessageReactionExtensions(index int, operationID string) {
	...
	//params = append(params, &temp1)
	drobot_im_sdk.AddMessageReactionExtensions(testAddMessageReactionExtensionsCallBack, testAddMessageReactionExtensionsCallBack.OperationID, utils.StructToJsonString(s),
		utils.StructToJsonString(params))
}
func DoTestGetMessageListReactionExtensions(operationID string) {
	...
	ss = append(ss, s1)
	//params = append(params, &temp1)
	drobot_im_sdk.GetMessageListReactionExtensions(testGetMessageReactionExtensionsCallBack, testGetMessageReactionExtensionsCallBack.OperationID, utils.StructToJsonString(ss))
}
func DoTestUpdateFcmToken() {
	...
	drobot_im_sdk.UpdateFcmToken(testUpdateFcmTokenCallBack, "2132323", testUpdateFcmTokenCallBack.OperationID)
}
func DoTestSetAppBadge() {
	...
	drobot_im_sdk.SetAppBadge(testSetAppBadgeCallBack, testSetAppBadgeCallBack.OperationID, 100)
}
...
func DoTestGetAdvancedHistoryMessageList() {
	...
	drobot_im_sdk.GetAdvancedHistoryMessageList(testGetHistoryCallBack, testGetHistoryCallBack.OperationID, utils.StructToJsonString(params))
}
func DoTestGetHistoryMessageReverse(userID string) {
	...
	drobot_im_sdk.GetHistoryMessageListReverse(testGetHistoryReverseCallBack, testGetHistoryReverseCallBack.OperationID, utils.StructToJsonString(params))
}
...
//	drobot_im_sdk.DeleteConversation(conversationID, testDeleteConversation)
//
//}
...
func DoTestDeleteMessageFromLocalAndSvr(callback drobot_sdk_callback.Base, message string) {
	...
	operationID := utils.OperationIDGenerator()
	drobot_im_sdk.DeleteMessageFromLocalAndSvr(cb, operationID, utils.StructToJsonString(msg))
}

func DoTestDeleteConversationMsgFromLocalAndSvr(conversationID string) {
	cb := &DeleteMessageCallBack{}
	operationID := utils.OperationIDGenerator()
	drobot_im_sdk.DeleteConversationFromLocalAndSvr(cb, operationID, conversationID)
}
...
func DoTestGetAllConversation() {
	...
	drobot_im_sdk.GetAllConversationList(test, test.OperationID)
}

func DoTestGetOneConversation(friendID string) {
	var test TestGetAllConversationListCallBack
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.GetOneConversation(test, test.OperationID, constant.SingleChatType, friendID)
}

func DoTestGetConversations(conversationIDs string) {
	var test TestGetAllConversationListCallBack
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.GetMultipleConversation(test, test.OperationID, conversationIDs)
}
...
func DoTestSetConversationRecvMessageOpt(conversationIDs []string, opt int) {
	...
	drobot_im_sdk.SetConversationRecvMessageOpt(callback, callback.OperationID, s, opt)
}

func DoTestSetConversationPinned(conversationID string, pin bool) {
	var test TestSetConversationPinnedCallback
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.PinConversation(test, test.OperationID, conversationID, pin)
}

func DoTestSetOneConversationPrivateChat(conversationID string, privateChat bool) {
	var test TestSetConversationPinnedCallback
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.SetOneConversationPrivateChat(test, test.OperationID, conversationID, privateChat)
}

func DoTestSetBurnDuration(conversationID string) {
	var test TestSetConversationPinnedCallback
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.SetOneConversationBurnDuration(test, test.OperationID, conversationID, 180)
}

func DoTestSetOneConversationRecvMessageOpt(conversationID string, opt int) {
	var test TestSetConversationPinnedCallback
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.SetOneConversationRecvMessageOpt(test, test.OperationID, conversationID, opt)
}
...
func DoTestGetConversationListSplit() {
	...
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.GetConversationListSplit(test, test.OperationID, 1, 2)
}
...
func DoTestGetConversationRecvMessageOpt(list string) {
	...
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.GetConversationRecvMessageOpt(test, test.OperationID, list)
}
...
//		drobot_im_sdk.GetOneConversation(sourceID, sessionType, test)
//
// }
func DoTestCreateTextMessage(text string) string {
	operationID := utils.OperationIDGenerator()
	return drobot_im_sdk.CreateTextMessage(operationID, text)
}
...
func DoTestCreateImageMessageFromFullPath() string {
	operationID := utils.OperationIDGenerator()
	return drobot_im_sdk.CreateImageMessageFromFullPath(operationID, "C:\\Users\\Administrator\\Desktop\\rtc.proto")
	//drobot_im_sdk.SendMessage(&testSendMsg, operationID, s, , "", utils.StructToJsonString(o))
}

func DoTestCreateOtherMessageFromFullPath() string {
	operationID := utils.OperationIDGenerator()
	return drobot_im_sdk.CreateFileMessageFromFullPath(operationID, "C:\\Users\\Administrator\\Desktop\\2.txt", "2.txt")
	//drobot_im_sdk.SendMessage(&testSendMsg, operationID, s, , "", utils.StructToJsonString(o))
}

func DoTestCreateVideoMessageFromFullPath() string {
	operationID := utils.OperationIDGenerator()
	return drobot_im_sdk.CreateVideoMessageFromFullPath(operationID, "C:\\Users\\Administrator\\Desktop\\video_test.mp4", "mp4", 5, "C:\\Users\\Administrator\\Desktop\\shot.jpg")
}

//	func DoTestSetConversationDraft() {
//		var test TestSetConversationDraft
//		drobot_im_sdk.SetConversationDraft("single_c93bc8b171cce7b9d1befb389abfe52f", "hah", test)
//
// }
...
//	drobot_im_sdk.SearchLocalMessages(t, operationID, utils.StructToJsonString(p))
//}
...
func DoTestDeleteConversation() {
	...
	drobot_im_sdk.DeleteConversation(t, operationID, conversationID)
}
...
//	drobot_im_sdk.MarkC2CMessageAsRead(test, Friend_uid, string(jsonid))
//}
...
func DoTestSetAppBackgroundStatus(isBackground bool) {
	...
	operationID := utils.OperationIDGenerator()
	drobot_im_sdk.SetAppBackgroundStatus(&testSendMsg, operationID, isBackground)
}
...
func DoTestSendMsg2(sendId, recvID string) {
	...
	o.Title = "121313"
	o.Desc = "45464"
	drobot_im_sdk.SendMessage(&testSendMsg, operationID, s, recvID, "", utils.StructToJsonString(o))
...
func DoTestSendMsg2Group(sendId, groupID string, index int) {
	...
	o.Title = "Title"
	o.Desc = "Desc"
	drobot_im_sdk.SendMessage(&testSendMsg, operationID, s, "", groupID, utils.StructToJsonString(o))
...
func DoTestMarkGroupMessageAsRead() {
	...
	drobot_im_sdk.MarkGroupMessageAsRead(&testMarkGroupMessageAsRead, operationID, groupID, utils.StructToJsonString(msgIDList))
...
func DotestUploadFile() {
	operationID := utils.OperationIDGenerator()
	var testSendMsg TestSendMsgCallBack
	drobot_im_sdk.UploadFile(&testSendMsg, operationID, "C:\\Users\\Administrator\\Desktop\\video_test.mp4")
}
...
func DoTestClearMsg() {
	...
	operationID := utils.OperationIDGenerator()
	drobot_im_sdk.DeleteAllMsgFromLocalAndSvr(&test, operationID)
...
func DoTestGetSelfUserInfo() {
	...
	drobot_im_sdk.GetSelfUserInfo(&test, "s")
}
