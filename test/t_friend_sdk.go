...
func DoTestGetFriendApplicationList() {
	...
	drobot_im_sdk.GetRecvFriendApplicationList(test, test.OperationID)
...
func DoTestSetSelfInfo() {
	...
	drobot_im_sdk.SetSelfInfo(test, test.OperationID, jsonString)
}
...
func DoTestGetUsersInfo() {
	...
	drobot_im_sdk.GetUsersInfo(test, test.OperationID, list)
}
...
func DoTestGetDesignatedFriendsInfo() {
	...
	drobot_im_sdk.GetDesignatedFriendsInfo(test, "xxxxxxxxxxx", string(jsontest))
}
...
func DoTestAddToBlackList() {
	...
	drobot_im_sdk.AddBlack(test, test.OperationID, Friend_uid)
}
...
func DoTestDeleteFromBlackList() {
	...
	drobot_im_sdk.RemoveBlack(test, test.OperationID, Friend_uid)
}
...
func DoTestGetBlackList() {
	...
	test.OperationID = utils.OperationIDGenerator()
	drobot_im_sdk.GetBlackList(test, test.OperationID)
}
...
func DoTestCheckFriend() {
	...
	drobot_im_sdk.CheckFriend(test, test.OperationID, list)
}
...
func DotestSetFriendRemark() {
	...
	drobot_im_sdk.SetFriendRemark(test, test.OperationID, jsontest)
}
...
func DotestDeleteFriend() {
	...
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input ")
	drobot_im_sdk.DeleteFriend(test, test.OperationID, Friend_uid)
}
...
func DoTestAddFriend() {
	...
	drobot_im_sdk.AddFriend(test, test.OperationID, jsontestaddFriend)
}
...
func DoTestGetSendFriendApplicationList() {
	...
	drobot_im_sdk.GetSendFriendApplicationList(test, test.OperationID)
}
...
func DotestGetFriendList() {
	...
	test.OperationID = utils.OperationIDGenerator()
	log.Info(test.OperationID, utils.GetSelfFuncName(), "input ")
	drobot_im_sdk.GetFriendList(test, test.OperationID)
}
...
func DotestSearchFriends() {
	...
	drobot_im_sdk.SearchFriends(test, test.OperationID, utils.StructToJsonString(params))
}
...
func DoTestAcceptFriendApplication() {
	...
	drobot_im_sdk.AcceptFriendApplication(test, test.OperationID, input)
}
...
func DoTestRefuseFriendApplication() {
	...
	param.ToUserID = Friend_uid
	input := utils.StructToJsonString(param)
	drobot_im_sdk.RefuseFriendApplication(test, test.OperationID, input)
}
...
//	drobot_im_sdk.RefuseFriendApplication(testRefuseFriendApplication, string(jsontestfusetFriendappclicatrion), "")
...
func InOutlllogin(uid, tk string) {
	...
	drobot_im_sdk.Login(&callback, operationID, uid, tk)
	for {
...
func InOutLogou() {
	...
	drobot_im_sdk.Logout(&callback, opretaionID)
}
...
func InOutDoTest(uid, tk, ws, api string) {
	...
	operationID := utils.OperationIDGenerator()
	if !drobot_im_sdk.InitSDK(&testinit, operationID, s) {
		log.Error("", "InitSDK failed")
		return
	}

	var testConversation conversationCallBack
	drobot_im_sdk.SetConversationListener(&testConversation)

	var testUser userCallback
	drobot_im_sdk.SetUserListener(testUser)

	var msgCallBack MsgListenerCallBak
	drobot_im_sdk.SetAdvancedMsgListener(&msgCallBack)

	var batchMsg BatchMsg
	drobot_im_sdk.SetBatchMsgListener(&batchMsg)

	var friendListener testFriendListener
	drobot_im_sdk.SetFriendListener(friendListener)

	var groupListener testGroupListener
	drobot_im_sdk.SetGroupListener(groupListener)
	var signalingListener testSignalingListener
	drobot_im_sdk.SetSignalingListener(&signalingListener)

	var organizationListener testOrganizationListener
	drobot_im_sdk.SetOrganizationListener(organizationListener)

	var workMomentsListener testWorkMomentsListener
	drobot_im_sdk.SetWorkMomentsListener(workMomentsListener)
...
func lllogin(uid, tk string) bool {
	...
	callback.funcName = utils.GetSelfFuncName()
	operationID := utils.OperationIDGenerator()
	drobot_im_sdk.Login(&callback, uid, operationID, tk)
...
func DoTest(uid, tk, ws, api string) {
	...
	//var msgCallBack MsgListenerCallBak
	//drobot_im_sdk.AddAdvancedMsgListener(msgCallBack)
...
//	drobot_im_sdk.GetAllConversationList(test)
//}
