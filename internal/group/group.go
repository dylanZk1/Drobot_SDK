...
import (
	"errors"
	"math/big"
	comm "drobot_sdk/internal/common"
...
type Group struct {
	listener    drobot_sdk_callback.OnGroupListener
	loginUserID string
	...
	listenerForService drobot_sdk_callback.OnListenerForService
}
...
func (g *Group) SetListenerForService(listener drobot_sdk_callback.OnListenerForService) {
...
func (g *Group) createGroup(callback drobot_sdk_callback.Base, group sdk.CreateGroupBaseInfoParam, memberList sdk.CreateGroupMemberRoleParam, operationID string) *sdk.CreateGroupCallback {
...
func (g *Group) joinGroup(groupID, reqMsg string, joinSource int32, callback drobot_sdk_callback.Base, operationID string) {
...
func (g *Group) quitGroup(groupID string, callback drobot_sdk_callback.Base, operationID string) {
...
func (g *Group) dismissGroup(groupID string, callback drobot_sdk_callback.Base, operationID string) {
...
func (g *Group) changeGroupMute(groupID string, isMute bool, callback drobot_sdk_callback.Base, operationID string) {
	if isMute {
...
func (g *Group) changeGroupMemberMute(groupID, userID string, mutedSeconds uint32, callback drobot_sdk_callback.Base, operationID string) {
	if mutedSeconds == 0 {
...
//	}
func (g *Group) setGroupMemberRoleLevel(callback drobot_sdk_callback.Base, groupID, userID string, roleLevel int, operationID string) {
...
func (g *Group) setGroupMemberInfo(callback drobot_sdk_callback.Base, param sdk.SetGroupMemberInfoParam, operationID string) {
...
func (g *Group) getJoinedGroupList(callback drobot_sdk_callback.Base, operationID string) sdk.GetJoinedGroupListCallback {
...
func (g *Group) searchGroups(callback drobot_sdk_callback.Base, param sdk.SearchGroupsParam, operationID string) sdk.SearchGroupsCallback {
...
func (g *Group) getGroupsInfo(groupIDList sdk.GetGroupsInfoParam, callback drobot_sdk_callback.Base, operationID string) sdk.GetGroupsInfoCallback {
	groupList, err := g.db.GetJoinedGroupListDB()
	common.CheckDBErrCallback(callback, err, operationID)
...
func (g *Group) setGroupInfo(callback drobot_sdk_callback.Base, groupInfo sdk.SetGroupInfoParam, groupID, operationID string) {
...
func (g *Group) modifyGroupInfo(callback drobot_sdk_callback.Base, apiReq api.SetGroupInfoReq, operationID string) {
...
// todo
func (g *Group) getGroupMemberList(callback drobot_sdk_callback.Base, groupID string, filter, offset, count int32, operationID string) sdk.GetGroupMemberListCallback {
	groupInfoList, err := g.db.GetGroupMemberListSplit(groupID, filter, int(offset), int(count))
	common.CheckDBErrCallback(callback, err, operationID)
	return groupInfoList
}

func (g *Group) getGroupMemberOwnerAndAdmin(callback drobot_sdk_callback.Base, groupID string, operationID string) sdk.GetGroupMemberListCallback {
	groupInfoList, err := g.db.GetGroupMemberOwnerAndAdmin(groupID)
	common.CheckDBErrCallback(callback, err, operationID)
	return groupInfoList
}

func (g *Group) getGroupMemberListByJoinTimeFilter(callback drobot_sdk_callback.Base, groupID string, offset, count int32, joinTimeBegin, joinTimeEnd int64, userIDList []string, operationID string) sdk.GetGroupMemberListCallback {
	if joinTimeEnd == 0 {
...
// todo
func (g *Group) getGroupMembersInfo(callback drobot_sdk_callback.Base, groupID string, userIDList sdk.GetGroupMembersInfoParam, operationID string) sdk.GetGroupMembersInfoCallback {
	groupInfoList, err := g.db.GetGroupSomeMemberInfo(groupID, userIDList)
	common.CheckDBErrCallback(callback, err, operationID)
	return groupInfoList
}

func (g *Group) kickGroupMember(callback drobot_sdk_callback.Base, groupID string, memberList sdk.KickGroupMemberParam, reason string, operationID string) sdk.KickGroupMemberCallback {
...
func (g *Group) transferGroupOwner(callback drobot_sdk_callback.Base, groupID, newOwnerUserID string, operationID string) {
...
func (g *Group) inviteUserToGroup(callback drobot_sdk_callback.Base, groupID, reason string, userList sdk.InviteUserToGroupParam, operationID string) sdk.InviteUserToGroupCallback {
...
// //1
func (g *Group) getRecvGroupApplicationList(callback drobot_sdk_callback.Base, operationID string) sdk.GetGroupApplicationListCallback {
	applicationList, err := g.db.GetAdminGroupApplication()
	common.CheckDBErrCallback(callback, err, operationID)
	return applicationList
}

func (g *Group) getSendGroupApplicationList(callback drobot_sdk_callback.Base, operationID string) sdk.GetSendGroupApplicationListCallback {
...
func (g *Group) processGroupApplication(callback drobot_sdk_callback.Base, groupID, fromUserID, handleMsg string, handleResult int32, operationID string) {
...
func (g *Group) setGroupMemberNickname(callback drobot_sdk_callback.Base, groupID, userID string, GroupMemberNickname string, operationID string) {
...
func (g *Group) searchGroupMembers(callback drobot_sdk_callback.Base, searchParam sdk.SearchGroupMembersParam, operationID string) sdk.SearchGroupMembersCallback {
