...
func (g *Group) SetGroupListener(callback drobot_sdk_callback.OnGroupListener) {
	if callback == nil {
		return
	}
	g.listener = callback
...
func (g *Group) CreateGroup(callback drobot_sdk_callback.Base, groupBaseInfo string, memberList string, operationID string) {
	if callback == nil {
		return
	}
...
func (g *Group) JoinGroup(callback drobot_sdk_callback.Base, groupID, reqMsg string, joinSource int32, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) QuitGroup(callback drobot_sdk_callback.Base, groupID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) DismissGroup(callback drobot_sdk_callback.Base, groupID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) ChangeGroupMute(callback drobot_sdk_callback.Base, groupID string, isMute bool, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) ChangeGroupMemberMute(callback drobot_sdk_callback.Base, groupID, userID string, mutedSeconds uint32, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) SetGroupMemberInfo(callback drobot_sdk_callback.Base, groupMemberInfo string, operationID string) {
...
func (g *Group) GetJoinedGroupList(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) GetGroupsInfo(callback drobot_sdk_callback.Base, groupIDList string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) SearchGroups(callback drobot_sdk_callback.Base, searchParam, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) SetGroupInfo(callback drobot_sdk_callback.Base, groupInfo string, groupID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) SetGroupVerification(callback drobot_sdk_callback.Base, verification int32, groupID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) SetGroupLookMemberInfo(callback drobot_sdk_callback.Base, rule int32, groupID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) SetGroupApplyMemberFriend(callback drobot_sdk_callback.Base, rule int32, groupID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) GetGroupMemberList(callback drobot_sdk_callback.Base, groupID string, filter, offset, count int32, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) GetGroupMemberOwnerAndAdmin(callback drobot_sdk_callback.Base, groupID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) GetGroupMemberListByJoinTimeFilter(callback drobot_sdk_callback.Base, groupID string, offset, count int32, joinTimeBegin, joinTimeEnd int64, filterUserID, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) GetGroupMembersInfo(callback drobot_sdk_callback.Base, groupID string, userIDList string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) KickGroupMember(callback drobot_sdk_callback.Base, groupID string, reason string, userIDList string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) InviteUserToGroup(callback drobot_sdk_callback.Base, groupID, reason string, userIDList string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) GetRecvGroupApplicationList(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) GetSendGroupApplicationList(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) AcceptGroupApplication(callback drobot_sdk_callback.Base, groupID, fromUserID, handleMsg string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) RefuseGroupApplication(callback drobot_sdk_callback.Base, groupID, fromUserID, handleMsg string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (g *Group) SearchGroupMembers(callback drobot_sdk_callback.Base, searchParam string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
