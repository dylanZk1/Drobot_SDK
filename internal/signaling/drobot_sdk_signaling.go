...
func (s *LiveSignaling) InviteInGroup(callback drobot_sdk_callback.Base, signalInviteInGroupReq string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
	var listenerList []drobot_sdk_callback.OnSignalingListener
	if s.listener != nil {
...
func (s *LiveSignaling) Invite(callback drobot_sdk_callback.Base, signalInviteReq string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (s *LiveSignaling) Accept(callback drobot_sdk_callback.Base, signalAcceptReq string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (s *LiveSignaling) Reject(callback drobot_sdk_callback.Base, signalRejectReq string, operationID string) {
	if callback == nil {
...
func (s *LiveSignaling) Cancel(callback drobot_sdk_callback.Base, signalCancelReq string, operationID string) {
	if callback == nil {
		log.NewError(operationID, "callback is nil")
	}
	var listenerList []drobot_sdk_callback.OnSignalingListener
...
func (s *LiveSignaling) HungUp(callback drobot_sdk_callback.Base, signalHungUpReq string, operationID string) {
	if callback == nil {
		log.NewError(operationID, "callback is nil")
	}
	var listenerList []drobot_sdk_callback.OnSignalingListener
...
func (s *LiveSignaling) SignalingGetRoomByGroupID(callback drobot_sdk_callback.Base, groupID, operationID string) {
	if callback == nil {
		log.NewError(operationID, "callback is nil")
	}
	if s.listener == nil {
...
func (s *LiveSignaling) SignalingGetTokenByRoomID(callback drobot_sdk_callback.Base, groupID, operationID string) {
	if callback == nil {
		log.NewError(operationID, "callback is nil")
	}
	if s.listener == nil {
