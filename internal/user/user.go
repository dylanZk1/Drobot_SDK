...
type User struct {
	...
	p              *ws.PostApi
	loginUserID string
	listener    drobot_sdk_callback.OnUserListener
	loginTime   int64
...
func (u *User) SetListener(listener drobot_sdk_callback.OnUserListener) {
	u.listener = listener
}
...
func (u *User) GetUsersInfoFromSvr(callback drobot_sdk_callback.Base, UserIDList sdk.GetUsersInfoParam, operationID string) []*api.PublicUserInfo {
...
func (u *User) getSelfUserInfo(callback drobot_sdk_callback.Base, operationID string) sdk.GetSelfUserInfoCallback {
...
func (u *User) updateSelfUserInfo(callback drobot_sdk_callback.Base, userInfo sdk.SetSelfUserInfoParam, operationID string) {
