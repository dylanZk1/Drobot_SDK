...
func (c *Conversation) GetAllConversationList(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) GetConversationListSplit(callback drobot_sdk_callback.Base, offset, count int, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SetConversationRecvMessageOpt(callback drobot_sdk_callback.Base, conversationIDList string, opt int, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SetGlobalRecvMessageOpt(callback drobot_sdk_callback.Base, opt int, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) HideConversation(callback drobot_sdk_callback.Base, conversationID string, operationID string) {
...
// deprecated
func (c *Conversation) GetConversationRecvMessageOpt(callback drobot_sdk_callback.Base, conversationIDList, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) GetOneConversation(callback drobot_sdk_callback.Base, sessionType int32, sourceID, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) GetMultipleConversation(callback drobot_sdk_callback.Base, conversationIDList string, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) DeleteConversation(callback drobot_sdk_callback.Base, conversationID string, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) DeleteAllConversationFromLocal(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SetConversationDraft(callback drobot_sdk_callback.Base, conversationID, draftText string, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) ResetConversationGroupAtType(callback drobot_sdk_callback.Base, conversationID, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) PinConversation(callback drobot_sdk_callback.Base, conversationID string, isPinned bool, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SetOneConversationPrivateChat(callback drobot_sdk_callback.Base, conversationID string, isPrivate bool, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SetOneConversationBurnDuration(callback drobot_sdk_callback.Base, conversationID string, burnDuration int32, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SetOneConversationRecvMessageOpt(callback drobot_sdk_callback.Base, conversationID string, opt int, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) GetTotalUnreadMsgCount(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SetConversationListener(listener drobot_sdk_callback.OnConversationListener) {
...
func (c *Conversation) GetConversationsByUserID(callback drobot_sdk_callback.Base, operationID string, UserID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) checkErrAndUpdateMessage(callback drobot_sdk_callback.SendMsgCallBack, errCode int32, err error, s *sdk_struct.MsgStruct, lc *model_struct.LocalConversation, operationID string) {
	if err != nil {
		if callback != nil {
...
func (c *Conversation) SendMessage(callback drobot_sdk_callback.SendMsgCallBack, message, recvID, groupID string, offlinePushInfo string, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SendMessageNotOss(callback drobot_sdk_callback.SendMsgCallBack, message, recvID, groupID string, offlinePushInfo string, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) SendMessageByBuffer(callback drobot_sdk_callback.SendMsgCallBack, message, recvID, groupID string, offlinePushInfo string, operationID string, buffer1, buffer2 *bytes.Buffer) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) InternalSendMessage(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, recvID, groupID, operationID string, p *server_api_params.OfflinePushInfo, onlineUserOnly bool, options map[string]bool) (*server_api_params.UserSendMsgResp, error) {
	if recvID == "" && groupID == "" {
		common.CheckAnyErrCallback(callback, 201, errors.New("recvID && groupID not both null"), operationID)
	}
	if recvID == "" {
...
func (c *Conversation) sendMessageToServer(s *sdk_struct.MsgStruct, lc *model_struct.LocalConversation, callback drobot_sdk_callback.SendMsgCallBack,
...
func (c *Conversation) FindMessageList(callback drobot_sdk_callback.Base, findMessageOptions, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) GetHistoryMessageList(callback drobot_sdk_callback.Base, getMessageOptions, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) GetAdvancedHistoryMessageList(callback drobot_sdk_callback.Base, getMessageOptions, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) GetAdvancedHistoryMessageListReverse(callback drobot_sdk_callback.Base, getMessageOptions, operationID string) {
	var unmarshalParams sdk_params_callback.GetAdvancedHistoryMessageListParams
	common.JsonUnmarshalCallback(getMessageOptions, &unmarshalParams, callback, operationID)
...
func (c *Conversation) GetHistoryMessageListReverse(callback drobot_sdk_callback.Base, getMessageOptions, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) RevokeMessage(callback drobot_sdk_callback.Base, message string, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) NewRevokeMessage(callback drobot_sdk_callback.Base, message string, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) TypingStatusUpdate(callback drobot_sdk_callback.Base, recvID, msgTip, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) MarkC2CMessageAsRead(callback drobot_sdk_callback.Base, userID string, msgIDList, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) MarkMessageAsReadByConID(callback drobot_sdk_callback.Base, conversationID, msgIDList, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
// fixme
func (c *Conversation) MarkAllConversationHasRead(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
// deprecated
func (c *Conversation) MarkGroupMessageHasRead(callback drobot_sdk_callback.Base, groupID string, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) MarkGroupMessageAsRead(callback drobot_sdk_callback.Base, groupID string, msgIDList, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) DeleteMessageFromLocalStorage(callback drobot_sdk_callback.Base, message string, operationID string) {
	go func() {
		s := sdk_struct.MsgStruct{}
		common.JsonUnmarshalAndArgsValidate(message, &s, callback, operationID)
...
func (c *Conversation) ClearC2CHistoryMessage(callback drobot_sdk_callback.Base, userID string, operationID string) {
	go func() {
...
func (c *Conversation) ClearGroupHistoryMessage(callback drobot_sdk_callback.Base, groupID string, operationID string) {
	go func() {
...
func (c *Conversation) ClearC2CHistoryMessageFromLocalAndSvr(callback drobot_sdk_callback.Base, userID string, operationID string) {
	if callback == nil {
		return
	}
...
// fixme
func (c *Conversation) ClearGroupHistoryMessageFromLocalAndSvr(callback drobot_sdk_callback.Base, groupID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (c *Conversation) InsertSingleMessageToLocalStorage(callback drobot_sdk_callback.Base, message, recvID, sendID, operationID string) {
	go func() {
...
func (c *Conversation) InsertGroupMessageToLocalStorage(callback drobot_sdk_callback.Base, message, groupID, sendID, operationID string) {
	go func() {
...
//modifyLocalMessages(callback drobot_sdk_callback.Base, message, groupID, sendID, operationID string)

func (c *Conversation) SetConversationStatus(callback drobot_sdk_callback.Base, operationID string, userID string, status int) {
	if callback == nil {
...
func (c *Conversation) SearchLocalMessages(callback drobot_sdk_callback.Base, searchParam, operationID string) {
	if callback == nil {
		return
	}
	go func() {
...
func (c *Conversation) DeleteConversationFromLocalAndSvr(callback drobot_sdk_callback.Base, conversationID string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (c *Conversation) DeleteMessageFromLocalAndSvr(callback drobot_sdk_callback.Base, message string, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (c *Conversation) DeleteAllMsgFromLocalAndSvr(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (c *Conversation) DeleteAllMsgFromLocal(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		return
	}
	fName := utils.GetSelfFuncName()
...
func (c *Conversation) SetMessageReactionExtensions(callback drobot_sdk_callback.Base, message, reactionExtensionList, operationID string) {
	s := sdk_struct.MsgStruct{}
	common.JsonUnmarshalAndArgsValidate(message, &s, callback, operationID)
...
func (c *Conversation) AddMessageReactionExtensions(callback drobot_sdk_callback.Base, message, reactionExtensionList, operationID string) {
	s := sdk_struct.MsgStruct{}
	common.JsonUnmarshalAndArgsValidate(message, &s, callback, operationID)
...
func (c *Conversation) DeleteMessageReactionExtensions(callback drobot_sdk_callback.Base, message, reactionExtensionKeyList, operationID string) {
	s := sdk_struct.MsgStruct{}
	common.JsonUnmarshalAndArgsValidate(message, &s, callback, operationID)
...
func (c *Conversation) GetMessageListReactionExtensions(callback drobot_sdk_callback.Base, messageList, operationID string) {
 ...
 */
func (c *Conversation) GetMessageListSomeReactionExtensions(callback drobot_sdk_callback.Base, messageList, reactionExtensionKeyList, operationID string) {
...
func (c *Conversation) SetTypeKeyInfo(callback drobot_sdk_callback.Base, message, typeKey, ex string, isCanRepeat bool, operationID string) {
	s := sdk_struct.MsgStruct{}
	common.JsonUnmarshalAndArgsValidate(message, &s, callback, operationID)
...
func (c *Conversation) GetTypeKeyListInfo(callback drobot_sdk_callback.Base, message, typeKeyList, operationID string) {
	s := sdk_struct.MsgStruct{}
	common.JsonUnmarshalAndArgsValidate(message, &s, callback, operationID)
	var list []string
...
func (c *Conversation) GetAllTypeKeyInfo(callback drobot_sdk_callback.Base, message, operationID string) {
	s := sdk_struct.MsgStruct{}
	common.JsonUnmarshalAndArgsValidate(message, &s, callback, operationID)
