...
func (c *Conversation) getAllConversationList(callback drobot_sdk_callback.Base, operationID string) sdk.GetAllConversationListCallback {
...
func (c *Conversation) getConversationListSplit(callback drobot_sdk_callback.Base, offset, count int, operationID string) sdk.GetConversationListSplitCallback {
...
func (c *Conversation) setConversation(callback drobot_sdk_callback.Base, apiReq *server_api_params.ModifyConversationFieldReq, conversationID string, localConversation *model_struct.LocalConversation, operationID string) {
...
func (c *Conversation) setGlobalRecvMessageOpt(callback drobot_sdk_callback.Base, opt int32, operationID string) {
...
func (c *Conversation) setOneConversationUnread(callback drobot_sdk_callback.Base, conversationID string, unreadCount int, operationID string) {
	apiReq := &server_api_params.ModifyConversationFieldReq{}
	localConversation, err := c.db.GetConversation(conversationID)
	common.CheckDBErrCallback(callback, err, operationID)
...
func (c *Conversation) setOneConversationPinned(callback drobot_sdk_callback.Base, conversationID string, isPinned bool, operationID string) {
	apiReq := &server_api_params.ModifyConversationFieldReq{}
	localConversation, err := c.db.GetConversation(conversationID)
	common.CheckDBErrCallback(callback, err, operationID)
...
func (c *Conversation) setOneConversationGroupAtType(callback drobot_sdk_callback.Base, conversationID, operationID string) {
...
func (c *Conversation) getConversationRecvMessageOpt(callback drobot_sdk_callback.Base, conversationIDList []string, operationID string) []server_api_params.GetConversationRecvMessageOptResp {
...
func (c *Conversation) getOneConversation(callback drobot_sdk_callback.Base, sourceID string, sessionType int32, operationID string) *model_struct.LocalConversation {
...
func (c *Conversation) getMultipleConversation(callback drobot_sdk_callback.Base, conversationIDList []string, operationID string) sdk.GetMultipleConversationCallback {
	conversationList, err := c.db.GetMultipleConversationDB(conversationIDList)
	common.CheckDBErrCallback(callback, err, operationID)
	return conversationList
}

func (c *Conversation) deleteConversation(callback drobot_sdk_callback.Base, conversationID, operationID string) {
	lc, err := c.db.GetConversation(conversationID)
	common.CheckDBErrCallback(callback, err, operationID)
	var sourceID string
...
func (c *Conversation) setConversationDraft(callback drobot_sdk_callback.Base, conversationID, draftText, operationID string) {
	if draftText != "" {
...
func (c *Conversation) getHistoryMessageList(callback drobot_sdk_callback.Base, req sdk.GetHistoryMessageListParams, operationID string, isReverse bool) sdk.GetHistoryMessageListCallback {
	t := time.Now()
	var sourceID string
...
func (c *Conversation) getAdvancedHistoryMessageList(callback drobot_sdk_callback.Base, req sdk.GetAdvancedHistoryMessageListParams, operationID string, isReverse bool) sdk.GetAdvancedHistoryMessageListCallback {
	t := time.Now()
...
func (c *Conversation) getAdvancedHistoryMessageList2(callback drobot_sdk_callback.Base, req sdk.GetAdvancedHistoryMessageListParams, operationID string, isReverse bool) sdk.GetAdvancedHistoryMessageListCallback {
	t := time.Now()
	var messageListCallback sdk.GetAdvancedHistoryMessageListCallback
	var sourceID string
	var conversationID string
...
func (c *Conversation) revokeOneMessage(callback drobot_sdk_callback.Base, req sdk.RevokeMessageParams, operationID string) {
...
func (c *Conversation) newRevokeOneMessage(callback drobot_sdk_callback.Base, req sdk.RevokeMessageParams, operationID string) {
	var recvID, groupID string
	var localMessage model_struct.LocalChatLog
...
func (c *Conversation) markC2CMessageAsRead(callback drobot_sdk_callback.Base, msgIDList sdk.MarkC2CMessageAsReadParams, userID, operationID string) {
	var localMessage model_struct.LocalChatLog
...
func (c *Conversation) markGroupMessageAsRead(callback drobot_sdk_callback.Base, msgIDList sdk.MarkGroupMessageAsReadParams, groupID, operationID string) {
...
//	func (c *Conversation) markMessageAsReadByConID(callback drobot_sdk_callback.Base, msgIDList sdk.MarkMessageAsReadByConIDParams, conversationID, operationID string) {
...
//		//_ = common.TriggerCmdUpdateConversation(common.UpdateConNode{ConID: conversationID, Action: constant.ConChange, Args: []string{conversationID}}, c.ch)
//	}
func (c *Conversation) insertMessageToLocalStorage(callback drobot_sdk_callback.Base, s *model_struct.LocalChatLog, operationID string) string {
...
func (c *Conversation) deleteMessageFromSvr(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, operationID string) {
...
func (c *Conversation) clearMessageFromSvr(callback drobot_sdk_callback.Base, operationID string) {
...
func (c *Conversation) deleteMessageFromLocalStorage(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, operationID string) {
...
func (c *Conversation) searchLocalMessages(callback drobot_sdk_callback.Base, searchParam sdk.SearchLocalMessagesParams, operationID string) (r sdk.SearchLocalMessagesCallback) {
...
func (c *Conversation) deleteConversationAndMsgFromSvr(callback drobot_sdk_callback.Base, conversationID, operationID string) {
...
func (c *Conversation) deleteAllMsgFromSvr(callback drobot_sdk_callback.Base, operationID string) {
	log.NewInfo(operationID, utils.GetSelfFuncName())
...
func (c *Conversation) setMessageReactionExtensions(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, req sdk.SetMessageReactionExtensionsParams, operationID string) []*server_api_params.ExtensionResult {
...
func (c *Conversation) addMessageReactionExtensions(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, req sdk.AddMessageReactionExtensionsParams, operationID string) []*server_api_params.ExtensionResult {
	message, err := c.db.GetMessageController(s)
	common.CheckDBErrCallback(callback, err, operationID)
...
func (c *Conversation) deleteMessageReactionExtensions(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, req sdk.DeleteMessageReactionExtensionsParams, operationID string) []*server_api_params.ExtensionResult {
	message, err := c.db.GetMessageController(s)
	common.CheckDBErrCallback(callback, err, operationID)
	if message.Status != constant.MsgStatusSendSuccess {
		common.CheckAnyErrCallback(callback, 201, errors.New("only send success message can modify reaction extensions"), operationID)
...
func (c *Conversation) getMessageListReactionExtensions(callback drobot_sdk_callback.Base, messageList []*sdk_struct.MsgStruct, operationID string) server_api_params.GetMessageListReactionExtensionsResp {
...
func (c *Conversation) getMessageListSomeReactionExtensions(callback drobot_sdk_callback.Base, messageList []*sdk_struct.MsgStruct, keyList []string, operationID string) server_api_params.GetMessageListReactionExtensionsResp {
	if len(messageList) == 0 {
		common.CheckAnyErrCallback(callback, 201, errors.New("message list is null"), operationID)
	}
	var msgIDList []string
...
func (c *Conversation) setTypeKeyInfo(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, typeKey, ex string, isCanRepeat bool, operationID string) []*server_api_params.ExtensionResult {
	message, err := c.db.GetMessageController(s)
	common.CheckDBErrCallback(callback, err, operationID)
	if message.Status != constant.MsgStatusSendSuccess {
		common.CheckAnyErrCallback(callback, 201, errors.New("only send success message can modify reaction extensions"), operationID)
...
func (c *Conversation) getTypeKeyListInfo(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, keyList []string, operationID string) (result []*sdk.SingleTypeKeyInfoSum) {
	message, err := c.db.GetMessageController(s)
	common.CheckDBErrCallback(callback, err, operationID)
	if message.Status != constant.MsgStatusSendSuccess {
		common.CheckAnyErrCallback(callback, 201, errors.New("only send success message can modify reaction extensions"), operationID)
...
func (c *Conversation) getAllTypeKeyInfo(callback drobot_sdk_callback.Base, s *sdk_struct.MsgStruct, operationID string) (result []*sdk.SingleTypeKeyInfoSum) {
	message, err := c.db.GetMessageController(s)
	common.CheckDBErrCallback(callback, err, operationID)
	if message.Status != constant.MsgStatusSendSuccess {
		common.CheckAnyErrCallback(callback, 201, errors.New("only send success message can modify reaction extensions"), operationID)
