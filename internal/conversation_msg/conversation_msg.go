...
import (
	...
	common2 "drobot_sdk/internal/common"
...
type Conversation struct {
	*ws.Ws
	...
	msgListener          drobot_sdk_callback.OnAdvancedMsgListener
	msgKvListener        drobot_sdk_callback.OnMessageKvInfoListener
...
func (c *Conversation) SetListenerForService(listener drobot_sdk_callback.OnListenerForService) {
	c.listenerForService = listener
}

func (c *Conversation) MsgListener() drobot_sdk_callback.OnAdvancedMsgListener {
...
func (c *Conversation) SetMsgListener(msgListener drobot_sdk_callback.OnAdvancedMsgListener) {
	c.msgListener = msgListener
}
func (c *Conversation) SetMsgKvListener(msgKvListener drobot_sdk_callback.OnMessageKvInfoListener) {
	c.msgKvListener = msgKvListener
}
func (c *Conversation) SetBatchMsgListener(batchMsgListener drobot_sdk_callback.OnBatchMsgListener) {
...
func NewConversation(ws *ws.Ws, db db_interface.DataBase, p *ws.PostApi,
	...
	objectStorage common2.ObjectStorage, conversationListener drobot_sdk_callback.OnConversationListener,
	msgListener drobot_sdk_callback.OnAdvancedMsgListener, organization *organization.Organization, signaling *signaling.LiveSignaling,
