...
func (f *Friend) SetListener(listener drobot_sdk_callback.OnFriendshipListener) {
	f.friendListener = listener
}

func (f *Friend) SetListenerForService(listener drobot_sdk_callback.OnListenerForService) {
	f.listenerForService = listener
}

func (f *Friend) getDesignatedFriendsInfo(callback drobot_sdk_callback.Base, friendUserIDList sdk.GetDesignatedFriendsInfoParams, operationID string) sdk.GetDesignatedFriendsInfoCallback {
...
func (f *Friend) GetDesignatedFriendListInfo(callback drobot_sdk_callback.Base, friendUserIDList []string, operationID string) []*model_struct.LocalFriend {
	friendList, err := f.db.GetFriendInfoList(friendUserIDList)
	common.CheckDBErrCallback(callback, err, operationID)
	return friendList
}

func (f *Friend) GetDesignatedBlackListInfo(callback drobot_sdk_callback.Base, blackIDList []string, operationID string) []*model_struct.LocalBlack {
	blackList, err := f.db.GetBlackInfoList(blackIDList)
	common.CheckDBErrCallback(callback, err, operationID)
	return blackList
}

func (f *Friend) addFriend(callback drobot_sdk_callback.Base, userIDReqMsg sdk.AddFriendParams, operationID string) {
...
func (f *Friend) getRecvFriendApplicationList(callback drobot_sdk_callback.Base, operationID string) sdk.GetRecvFriendApplicationListCallback {
...
func (f *Friend) getSendFriendApplicationList(callback drobot_sdk_callback.Base, operationID string) sdk.GetSendFriendApplicationListCallback {
	log.NewInfo(operationID, utils.GetSelfFuncName(), "args: ")
...
func (f *Friend) processFriendApplication(callback drobot_sdk_callback.Base, userIDHandleMsg sdk.ProcessFriendApplicationParams, handleResult int32, operationID string) {
...
func (f *Friend) checkFriend(callback drobot_sdk_callback.Base, friendUserIDList sdk.CheckFriendParams, operationID string) sdk.CheckFriendCallback {
	log.NewInfo(operationID, utils.GetSelfFuncName(), "args: ", friendUserIDList)
	friendList, err := f.db.GetFriendInfoList(friendUserIDList)
	common.CheckDBErrCallback(callback, err, operationID)
	blackList, err := f.db.GetBlackInfoList(friendUserIDList)
...
func (f *Friend) deleteFriend(friendUserID sdk.DeleteFriendParams, callback drobot_sdk_callback.Base, operationID string) {
...
func (f *Friend) getFriendList(callback drobot_sdk_callback.Base, operationID string) sdk.GetFriendListCallback {
...
func (f *Friend) searchFriends(callback drobot_sdk_callback.Base, param sdk.SearchFriendsParam, operationID string) sdk.SearchFriendsCallback {
...
func (f *Friend) getBlackList(callback drobot_sdk_callback.Base, operationID string) sdk.GetBlackListCallback {
	localBlackList, err := f.db.GetBlackListDB()
	common.CheckDBErrCallback(callback, err, operationID)
...
func (f *Friend) setFriendRemark(userIDRemark sdk.SetFriendRemarkParams, callback drobot_sdk_callback.Base, operationID string) {
...
func (f *Friend) addBlack(callback drobot_sdk_callback.Base, blackUserID sdk.AddBlackParams, operationID string) {
...
func (f *Friend) removeBlack(callback drobot_sdk_callback.Base, blackUserID sdk.RemoveBlackParams, operationID string) {
	log.NewInfo(operationID, utils.GetSelfFuncName(), "args: ", blackUserID)
