...
//f
func (f *Friend) GetDesignatedFriendsInfo(callback drobot_sdk_callback.Base, friendUserIDList string, operationID string) {
	if callback == nil {
...
func (f *Friend) AddFriend(callback drobot_sdk_callback.Base, userIDReqMsg string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) GetRecvFriendApplicationList(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) GetSendFriendApplicationList(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) AcceptFriendApplication(callback drobot_sdk_callback.Base, userIDHandleMsg string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) RefuseFriendApplication(callback drobot_sdk_callback.Base, userIDHandleMsg string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) CheckFriend(callback drobot_sdk_callback.Base, friendUserIDList string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) DeleteFriend(callback drobot_sdk_callback.Base, friendUserID string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
//f
func (f *Friend) GetFriendList(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) SearchFriends(callback drobot_sdk_callback.Base, searchParam, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) SetFriendRemark(callback drobot_sdk_callback.Base, userIDRemark string, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) AddBlack(callback drobot_sdk_callback.Base, blackUserID, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) GetBlackList(callback drobot_sdk_callback.Base, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) RemoveBlack(callback drobot_sdk_callback.Base, blackUserID, operationID string) {
	if callback == nil {
		log.Error(operationID, "callback is nil")
		return
	}
...
func (f *Friend) SetFriendListener(listener drobot_sdk_callback.OnFriendshipListener) {
	if listener == nil {
		return
	}
