...
import (
	...
	"drobot_sdk/internal/interaction"
...
type Heartbeat struct {
	...
	*interaction.MsgSync
	...
	token    string
	listener drobot_sdk_callback.OnConnListener
...
func NewHeartbeat(msgSync *interaction.MsgSync, cmcCh chan common.Cmd2Value, listener drobot_sdk_callback.OnConnListener, token string, id2MinSeq map[string]uint32, full *full.Full) *Heartbeat {
