...
type Organization struct {
	listener    drobot_sdk_callback.OnOrganizationListener
	loginUserID string
...
func (o *Organization) getSubDepartment(callback drobot_sdk_callback.Base, departmentID string, offset, count int, operationID string) sdk_params_callback.GetSubDepartmentCallback {
	subDepartmentList, err := o.db.GetSubDepartmentList(departmentID, offset, count)
	common.CheckDBErrCallback(callback, err, operationID)
	return subDepartmentList
}

func (o *Organization) getDepartmentMember(callback drobot_sdk_callback.Base, departmentID string, offset, count int, operationID string) sdk_params_callback.GetDepartmentMemberCallback {
	departmentMemberLis, err := o.db.GetDepartmentMemberListByDepartmentID(departmentID, offset, count)
	common.CheckDBErrCallback(callback, err, operationID)
	return departmentMemberLis
}

func (o *Organization) getUserInDepartment(callback drobot_sdk_callback.Base, userID string, operationID string) sdk_params_callback.GetUserInDepartmentCallback {
...
func (o *Organization) getDepartmentMemberAndSubDepartment(callback drobot_sdk_callback.Base, departmentID string, operationID string) sdk_params_callback.GetDepartmentMemberAndSubDepartmentCallback {
...
func (o *Organization) getParentDepartmentList(callback drobot_sdk_callback.Base, departmentID string, operationID string) sdk_params_callback.GetParentDepartmentListCallback {
	parentDepartmentList, err := o.db.GetParentDepartmentList(departmentID)
	common.CheckDBErrCallback(callback, err, operationID)
	return parentDepartmentList
}

func (o *Organization) getDepartmentInfo(callback drobot_sdk_callback.Base, departmentID string, operationID string) sdk_params_callback.GetDepartmentInfoCallback {
	departmentInfo, err := o.db.GetDepartmentInfo(departmentID)
	common.CheckDBErrCallback(callback, err, operationID)
	return departmentInfo
}

func (o *Organization) searchOrganization(callback drobot_sdk_callback.Base, searchParam sdk_params_callback.SearchOrganizationParams, offset, count int, operationID string) sdk_params_callback.SearchOrganizationCallback {
