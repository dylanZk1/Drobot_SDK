...
import (
	"drobot_sdk/internal/business"
	"drobot_sdk/internal/cache"
	comm3 "drobot_sdk/internal/common"
	conv "drobot_sdk/internal/conversation_msg"
	"drobot_sdk/internal/friend"
	"drobot_sdk/internal/full"
	"drobot_sdk/internal/group"
	"drobot_sdk/internal/heartbeart"
	ws "drobot_sdk/internal/interaction"
	comm2 "drobot_sdk/internal/obj_storage"
	"drobot_sdk/internal/organization"
	"drobot_sdk/internal/signaling"
	"drobot_sdk/internal/super_group"
	"drobot_sdk/internal/user"
	workMoments "drobot_sdk/internal/work_moments"
...
type LoginMgr struct {
	...
	token        string
	loginUserID  string
	connListener drobot_sdk_callback.OnConnListener

	loginTime int64

	justOnceFlag bool

	groupListener               drobot_sdk_callback.OnGroupListener
	friendListener              drobot_sdk_callback.OnFriendshipListener
	conversationListener        drobot_sdk_callback.OnConversationListener
	advancedMsgListener         drobot_sdk_callback.OnAdvancedMsgListener
	batchMsgListener            drobot_sdk_callback.OnBatchMsgListener
	userListener                drobot_sdk_callback.OnUserListener
	signalingListener           drobot_sdk_callback.OnSignalingListener
	signalingListenerFroService drobot_sdk_callback.OnSignalingListener
	organizationListener        drobot_sdk_callback.OnOrganizationListener
	workMomentsListener         drobot_sdk_callback.OnWorkMomentsListener
	businessListener            drobot_sdk_callback.OnCustomBusinessListener
...
func (u *LoginMgr) SetConversationListener(conversationListener drobot_sdk_callback.OnConversationListener) {
...
func (u *LoginMgr) SetAdvancedMsgListener(advancedMsgListener drobot_sdk_callback.OnAdvancedMsgListener) {
	if u.conversation != nil {
...
func (u *LoginMgr) SetMessageKvInfoListener(messageKvInfoListener drobot_sdk_callback.OnMessageKvInfoListener) {
	if u.conversation != nil {
		u.conversation.SetMsgKvListener(messageKvInfoListener)
	}
}
func (u *LoginMgr) SetBatchMsgListener(batchMsgListener drobot_sdk_callback.OnBatchMsgListener) {
	if u.conversation != nil {
...
func (u *LoginMgr) SetFriendListener(friendListener drobot_sdk_callback.OnFriendshipListener) {
	if u.friend != nil {
...
func (u *LoginMgr) SetGroupListener(groupListener drobot_sdk_callback.OnGroupListener) {
	if u.group != nil {
...
func (u *LoginMgr) SetOrganizationListener(listener drobot_sdk_callback.OnOrganizationListener) {
...
func (u *LoginMgr) SetUserListener(userListener drobot_sdk_callback.OnUserListener) {
	//if u.signaling != nil {
...
func (u *LoginMgr) SetSignalingListener(listener drobot_sdk_callback.OnSignalingListener) {
	if u.signaling != nil {
		u.signaling.SetListener(listener)
	} else {
		u.signalingListener = listener
...
func (u *LoginMgr) SetSignalingListenerForService(listener drobot_sdk_callback.OnSignalingListener) {
	if u.signaling != nil {
...
func (u *LoginMgr) SetListenerForService(listener drobot_sdk_callback.OnListenerForService) {
...
func (u *LoginMgr) SetWorkMomentsListener(listener drobot_sdk_callback.OnWorkMomentsListener) {
...
func (u *LoginMgr) SetBusinessListener(listener drobot_sdk_callback.OnCustomBusinessListener) {
	if u.business != nil {
...
func (u *LoginMgr) wakeUp(cb drobot_sdk_callback.Base, operationID string) {
...
func (u *LoginMgr) login(userID, token string, cb drobot_sdk_callback.Base, operationID string) {
...
func (u *LoginMgr) InitSDK(config sdk_struct.IMConfig, listener drobot_sdk_callback.OnConnListener, operationID string) bool {
	u.imConfig = config
