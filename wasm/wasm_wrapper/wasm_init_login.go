...
func (w *WrapperInitLogin) InitSDK(_ js.Value, args []js.Value) interface{} {
	...
	return js.ValueOf(event_listener.NewCaller(drobot_im_sdk.InitSDK, callback, &args).SyncCall())
}
func (w *WrapperInitLogin) Login(_ js.Value, args []js.Value) interface{} {
	...
	return event_listener.NewCaller(drobot_im_sdk.Login, callback, &args).AsyncCallWithCallback()
}
func (w *WrapperInitLogin) Logout(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(drobot_im_sdk.Logout, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperInitLogin) WakeUp(_ js.Value, args []js.Value) interface{} {
	callback := event_listener.NewBaseCallback(utils.FirstLower(utils.GetSelfFuncName()), w.commonFunc)
	return event_listener.NewCaller(drobot_im_sdk.WakeUp, callback, &args).AsyncCallWithCallback()
}

func (w *WrapperInitLogin) GetLoginStatus(_ js.Value, args []js.Value) interface{} {
	return event_listener.NewCaller(drobot_im_sdk.GetLoginStatus, nil, &args).AsyncCallWithOutCallback()
}

func (w *WrapperInitLogin) GetLoginUser(_ js.Value, args []js.Value) interface{} {
	return event_listener.NewCaller(drobot_im_sdk.GetLoginUser, nil, &args).AsyncCallWithOutCallback()
}
