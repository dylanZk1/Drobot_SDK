...
//string Ex = 7;
//}
//drobot_im_sdk.FriendInfo(FriendUser) != imdb.Friend(FriendUserID)
...
//string Ex = 9;
//}
//drobot_im_sdk.FriendRequest == imdb.FriendRequest
...
//  int32 GroupType = 12;
//}
//  drobot_im_sdk.GroupInfo (OwnerUserID ,  MemberCount )> imdb.Group
...
//}  drobot_im_sdk.GroupMemberFullInfo(AppMangerLevel) > imdb.GroupMember
//  group_id char(64) NOT NULL,
...
//int64 HandleTime = 8;
//string Ex = 9;
//}drobot_im_sdk.GroupRequest == imdb.GroupRequest
...
//string Ex = 7;
//}
// drobot_im_sdk.BlackInfo(BlackUserInfo) != imdb.Black (BlockUserID)
